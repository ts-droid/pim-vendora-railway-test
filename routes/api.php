...
Route::prefix('/v1')->middleware(['api.key', 'gzip'])->group(function() {
    ...
    Route::prefix('/wms')->group(function() {
        ...
        Route::get('/unplaced-articles', [StockPlaceController::class, 'getUnplacedArticles']);
        ...
        Route::post('/stock-places/compartment-list-order', [StockPlaceController::class, 'setCompartmentListOrder']);
    ...
    Route::prefix('/newsletter')->group(function() {
        ...
        Route::get('/sender', [NewsletterController::class, 'getSenders'])->name('newsletter.getSenders');
    });
    ...
    Route::prefix('/stock-keep')->group(function() {
        ...
        Route::post('/transactions/recheck', [StockKeepController::class, 'recheck']);
        ...
        Route::post('/todo/brand', [StockKeepController::class, 'createBrandTodo']);

        Route::get('/report', [StockKeepController::class, 'getReport']);
    });
    ...
    Route::prefix('/articles')->group(function() {
        ...
        Route::get('/eta-order', [ArticleController::class, 'getEtaOrder'])->name('articles.getEtaOrder');
        ...
        Route::post('/{article}/faq', [ArticleController::class, 'createFAQ'])->name('articles.createFAQ');
        Route::post('/{article}/faq/{articleFaqEntry}', [ArticleController::class, 'updateFAQ'])->name('articles.updateFAQ');
        ...
        Route::get('/{article}/job/short-title', [ArticleController::class, 'getNewShortTitle']);
        Route::get('/{article}/job/shop-title', [ArticleController::class, 'getNewShopTitle']);
        Route::get('/{article}/job/color', [ArticleController::class, 'getNewColor']);
        ...
        Route::get('/{article}/job/meta-title', [ArticleController::class, 'getNewMetaTitle']);
        Route::get('/{article}/job/meta-description', [ArticleController::class, 'getNewMetaDescription']);
    ...
    Route::prefix('/purchase-orders')->group(function() {
        ...
        Route::get('/open', [PurchaseOrderController::class, 'getOpen'])->name('purchaseOrders.getOpen');
        Route::get('/pending', [PurchaseOrderController::class, 'getPending'])->name('purchaseOrders.getPending');
        Route::get('/closed', [PurchaseOrderController::class, 'getClosed'])->name('purchaseOrders.getClosed');
        Route::get('/search', [PurchaseOrderController::class, 'search'])->name('purchaseOrders.search');
        ...
        Route::get('/get-lines', [PurchaseOrderController::class, 'getLines']);
        ...
        Route::post('/{purchaseOrder}/send-v2', [PurchaseOrderController::class, 'send'])->name('purchaseOrders.sendV2');
        ...
        Route::post('/{purchaseOrder}/lines/{purchaseOrderLine}/set-state', [PurchaseOrderController::class, 'setLineAppState']);
    });
