...
Route::prefix('/v1')->middleware(['api.key', 'gzip'])->group(function() {
    ...
    Route::prefix('/purchase-orders')->group(function() {
        ...
        Route::post('/{purchaseOrder}/send-v2', [PurchaseOrderController::class, 'sendV2'])->name('purchaseOrders.sendV2');
        ...
        Route::get('/{purchaseOrder}/shipments', [PurchaseOrderController::class, 'getShipments'])->name('purchaseOrders.getShipments');
    });
