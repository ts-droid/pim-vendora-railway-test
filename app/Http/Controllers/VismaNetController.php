        ...
        if ($suppliers) {
            ...
            foreach ($suppliers as $supplier) {
                ...
                $supplierData = [
                    ...
                    'class' => (string) ($supplier['supplierClass']['id'] ?? ''),
                    'class_description' => (string) ($supplier['supplierClass']['description'] ?? ''),
                    'credit_terms' => (string) ($supplier['creditTerms']['id'] ?? ''),
                    ...
                    'main_address_line' => (string) ($supplier['mainAddress']['addressLine1'] ?? ''),
                    'main_address_city' => (string) ($supplier['mainAddress']['city'] ?? ''),
                    'main_address_country' => (string) ($supplier['mainAddress']['country']['id'] ?? ''),
                    'remit_address_line' => (string) ($supplier['remitAddress']['addressLine1'] ?? ''),
                    'remit_address_city' => (string) ($supplier['remitAddress']['city'] ?? ''),
                    'remit_address_country' => (string) ($supplier['remitAddress']['country']['id'] ?? ''),
                    'supplier_address_line' => (string) ($supplier['supplierAddress']['addressLine1'] ?? ''),
                    'supplier_address_city' => (string) ($supplier['supplierAddress']['city'] ?? ''),
                    'supplier_address_country' => (string) ($supplier['supplierAddress']['country']['id'] ?? ''),

                    'main_contact_name' => (string) ($supplier['mainContact']['name'] ?? ''),
                    'main_contact_attention' => (string) ($supplier['mainContact']['attention'] ?? ''),
                    'main_contact_email' => (string) ($supplier['mainContact']['email'] ?? ''),
                    'main_contact_phone1' => (string) ($supplier['mainContact']['phone1'] ?? ''),
                    'main_contact_phone2' => (string) ($supplier['mainContact']['phone2'] ?? ''),

                    'remit_contact_name' => (string) ($supplier['remitContact']['name'] ?? ''),
                    'remit_contact_attention' => (string) ($supplier['remitContact']['attention'] ?? ''),
                    'remit_contact_email' => (string) ($supplier['remitContact']['email'] ?? ''),
                    'remit_contact_phone1' => (string) ($supplier['remitContact']['phone1'] ?? ''),
                    'remit_contact_phone2' => (string) ($supplier['remitContact']['phone2'] ?? ''),

                    'supplier_contact_name' => (string) ($supplier['supplierContact']['name'] ?? ''),
                    'supplier_contact_attention' => (string) ($supplier['supplierContact']['attention'] ?? ''),
                    'supplier_contact_email' => (string) ($supplier['supplierContact']['email'] ?? ''),
                    'supplier_contact_phone1' => (string) ($supplier['supplierContact']['phone1'] ?? ''),
                    'supplier_contact_phone2' => (string) ($supplier['supplierContact']['phone2'] ?? ''),
                ];
