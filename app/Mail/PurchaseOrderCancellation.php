...
class PurchaseOrderCancellation extends Mailable
{
    ...
    )
    {
        ...
        $this->emailBody = ConfigController::getConfig('purchase_system_cancel_order_email_body');
        ...
        $this->emailBody = str_replace('{portal_link}', '<a href="' . $confirmURL . '" target="_blank">See more details here</a>', $this->emailBody);
    }
    ...
    {
        return new Content(
            view: 'emails.purchaseOrderCancel',
        );
    }
