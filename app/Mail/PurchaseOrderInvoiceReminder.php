...
class PurchaseOrderInvoiceReminder extends Mailable
{
    ...
    {
        $this->emailSubject = ConfigController::getConfig('purchase_system_invoice_reminder_email_subject');
        $this->emailBody = ConfigController::getConfig('purchase_system_invoice_reminder_email_body');
    ...
    {
        return new Content(
            view: 'emails.purchaseOrderInvoiceReminder',
        );
    }
