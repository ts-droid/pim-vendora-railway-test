...
class SendPurchaseOrder extends Mailable
{
    ...
    )
    {
        ...
        $this->emailBody = str_replace('{portal_link}', PurchaseOrderHelper::getSupplierPortalUrl($purchaseOrder->supplier), $this->emailBody);
    ...
    {
        return new Content(
            view: 'emails.raw', // TODO: Create this view file
        );
    }
