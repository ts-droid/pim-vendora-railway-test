...
class PurchaseOrderShippingReminder extends Mailable
{
    ...
    {
        $this->emailSubject = ConfigController::getConfig('purchase_system_shipping_documentation_reminder_email_subject');
        $this->emailBody = ConfigController::getConfig('purchase_system_shipping_documentation_reminder_email_body');
    ...
    {
        return new Content(
            view: 'emails.purchaseOrderShippingReminder',
        );
    }
