    ...
    public function getQuantityToOrder(Article $article, int $foresightDays): array
    {
        ...
        return [
            ...
            'debug'    => [
                ...
                'baseNeed = avg60 * foresightDays * trend * seasonIdx' => $baseNeed,
                'needPlusOrder = baseNeed + plannedOrdersQty' => $needPlusOrder,
                'availableSupply = stockOnHand + incomingPOQty - reservedQty' => $availableSupply,
                'finalNeed = needPlusOrder - availableSupply * growthFactor' => $finalNeed,
            ],
        ];
    }
